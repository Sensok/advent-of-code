...
#    req_num_times, letter = pattern.split(' ')
#    min_req_times, max_req_times = req_num_times.split('-')
#    letter_count = password.count(letter)
#    if letter_count >= int(min_req_times) and letter_count <= int(max_req_times):
#        count_valid_passwords += 1


for pattern, password in passwords:
    req_num_times, letter = pattern.split(' ')
    first_position, last_position = req_num_times.split('-')
    index_one = int(first_position) - 1
    index_two = int(last_position) - 1
    first_position_has_letter = False
    second_position_has_letter = False
    if password[index_one] == letter:
        first_position_has_letter = True
    if len(password) >= index_two and password[index_two] == letter:
        second_position_has_letter = True
    if first_position_has_letter and not second_position_has_letter:
        count_valid_passwords += 1
    elif not first_position_has_letter and second_position_has_letter:
        count_valid_passwords += 1
